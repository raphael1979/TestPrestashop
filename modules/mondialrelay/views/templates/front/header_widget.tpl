...
{*{if isset($addJsInTemplate)}*}
	...
	<script type="text/javascript" src="https://maps.google.com/maps/api/js?sensor=false&key=AIzaSyBhM-UroO07icRa3U3ISAd16lf1rNoKNNs"></script>
{*{/if}*}
...
{*<script type="text/javascript" src="{$new_base_dir|escape:'htmlall':'UTF-8'}views/js/jquery.plugin.mondialrelay.parcelshoppicker.2.0.0.js"></script>*}
